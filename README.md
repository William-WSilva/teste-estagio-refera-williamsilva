...
<img src="./ScriptsSQL/01_Total_Vendas_Frete_Produto_Ordem.png" width="400px" height="280px" alt="">

2. Valor de venda por tipo de produto;

<img src="./ScriptsSQL/02_Total_Vendas_Tipo_Produto.png" width="400px" height="280px" alt="">

3. Quantidade e valor das vendas por dia, mês, ano;

<img src="./ScriptsSQL/03_Total_Qtd_Valor_Dia_Mes_Ano.png" width="400px" height="280px" alt="">

4. Lucro dos meses;

<img src="./ScriptsSQL/04_Lucro_Meses.png" width="400px" height="280px" alt="">

5. Venda por produto;

<img src="./ScriptsSQL/05_Total_Venda_Produto.png" width="400px" height="280px" alt="">

6. Venda por cliente, cidade do cliente e estado;

<img src="./ScriptsSQL/06_Total_Venda_Cliente_Cidade_Estado.png" width="400px" height="280px" alt="">

7. Média de produtos vendidos;

<img src="./ScriptsSQL/07_Media_Venda_Produto.png" width="400px" height="280px" alt="">

8. Média de compras que um cliente faz.

<img src="./ScriptsSQL/08_Media_Compra_Cliente.png" width="400px" height="280px" alt="">
...
<img src="./ScriptsSQL/Analise_Tabelas_Modelagem_PowerBI.png" width="600" height="280px">
